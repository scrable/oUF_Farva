...
local Shared = function(self, unit, isSingle)
    ...
    -- hp border
    self.Glow = CreateFrame("Frame", nil, hp, BackdropTemplateMixin and "BackdropTemplate")
    ...
    -- pp border
    self.Glow.pp = CreateFrame("Frame", nil, pp, BackdropTemplateMixin and "BackdropTemplate")
...
local createCastbar = function(self, unit)
    local cb = CreateFrame("StatusBar", nil, self, BackdropTemplateMixin and "BackdropTemplate")
    ...
    if cfg.useSpellIcon then
        ...
        cb.IconGlow = CreateFrame("Frame", nil, cb, BackdropTemplateMixin and "BackdropTemplate")
